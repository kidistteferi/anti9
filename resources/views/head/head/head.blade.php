...
<div class="container">
  ...
  @foreach($data as $index => $value) 
    <tr>
      ...
      <div class="row">
<a href="{{ route('head.head.details',$value->id) }}" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-view-stacked" viewBox="0 0 16 16">
